...
from .views import UserRegisterView,UserEditView,PasswordChange,Password_changed_successfully,ShowProfilePageView,EditProfilePageView,CreateProfilePageView,CustomLoginView
